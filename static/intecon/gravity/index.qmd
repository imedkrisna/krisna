...
abstract: "This page is dedicated to teach students on running the gravity model in R. We uses dataset from CEPII, specifically BACI and the gravity dataset. We run in R and RStudio IDE, and we rely on ppml from the gravity package when demonstrating PPML."
...
ctr<-c("IDN","SGP","VNM","MYS","THA","PHL","USA","CHN")
...
[^2]: I added CHN and USA in this version. Previously it was only ASEAN6 and results were pretty funny.
