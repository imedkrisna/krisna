...
$$
\alpha_k \;=\; \frac{g_k \cdot \sum_\ell s_{\ell k}\,X_\ell}{\sum_{k'} g_{k'} \cdot \sum_\ell s_{\ell k'}\,X_\ell},
...
Named for Julio Rotemberg (1983), who used the same decomposition logic in a different IV setting; @paulgp formalised it for the Bartik.
:::

## Rotemberg weights: 2x2 {.m}
...
$$
\textstyle\sum_\ell s_{\ell,\text{Agri}} X_\ell = 0.011(-15.1)+0.714(-18.6)+0.189(-15.9) = -16.45
$$
$$
\textstyle\sum_\ell s_{\ell,\text{Manuf}} X_\ell = 0.989(-15.1)+0.286(-18.6)+0.811(-15.9) = -33.15
$$
...
The `bartik.weight` package (GitHub: paulgp/bartik-weight) does this and produces the @paulgp Table 5 diagnostic panel directly.
:::
...
## Frontier and Indonesian context {.m}
