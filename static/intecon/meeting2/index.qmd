...
$$
H: Q_F+2Q_C \leq 1000 ; F: 6Q_F^*+3Q_C^* \leq 3999
$$
...
1. Free trade is beneficial only if a country is more productive than foreign countries.
    ...
    - But even an unproductive country benefits from free trade by avoiding the high costs for goos that it woul otherwise have to prouce domestically
