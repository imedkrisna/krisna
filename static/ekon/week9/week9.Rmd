...
subtitle: "Week 9"
author: "Krisna Gupta"
date: "05 April 2021 (updated: `r Sys.Date()`)"
output:
...
.s[$$\text{Labour Participation Rate}=\frac{\text{Labour Force}}{\text{Population over 15 years old}}$$]
...
.xs[Source: Data from Sakernas, 2009–16. Taken from Sarah Xua Dong and Chris Manning (2017) Labour-Market Developments at a Time of Heightened Uncertainty.
Bulletin of Indonesian Economic Studies, 53:1, 1-25, DOI: 10.1080/00074918.2017.1326201]
...
.xs[source: World Development Indicators]
...
.s[$$\text{inflation rate}=\frac{\text{Price index year 2 - Price index year 1}}{\text{Price index year 1}} \times 100\%$$]
