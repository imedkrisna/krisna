...
Nea1<-data.frame("Q"=Nea$q,"MC"=Nea$MC,"AVC"=Nea$AVC,"ATC"=Nea$ATC)
kable(Nea1,format = "html", align = "cc",digits=2) %>%
...
### Long run profit in a perfect market {.m}
...
profit2
```
The firm now has to operate on a lower MR. In the long run, the number of firms will be just enough to sustain and no more profit left
...
## How monopolist maximize profit {.m}
