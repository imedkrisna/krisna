...
- [UN COMTRADE database](https://comtradeplus.un.org/) merupakan sumber data ekspor impor yang dikelola oleh PBB. Memiliki data yang sangat luas tentang ekspor impor berbagai negara dalam berbagai kode HS.
...
dat$LPDB<-log(dat$PDB) # menambahkan transformasi log
dat$Limport<-log(dat$import)
write_xlsx(dat,"dat.xlsx") # Ngesave hasilnya dalam excel di WD anda
```
...
- Dapat diakses di [comtradeplus.un.org](https://comtradeplus.un.org/).
