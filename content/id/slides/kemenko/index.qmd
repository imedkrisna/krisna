...
-   Pertama, estimasi parameter dengan algoritma Levinsohn-Petrin$^1$:

::: footer
$^1\mu^*_{it}$ acak, pola non-acak diserap oleh $\phi (m_{it},k_{it})$
:::
...
- Pahami selalu _opportunity cost_ dari setiap kebijakan.
...
## Simple average of tariffs from 2008-2012 {.smaller}
