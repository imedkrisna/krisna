...
<div style='position: relative; padding-bottom: 56.25%; padding-top: 35px; height: 0; overflow: hidden;'><iframe sandbox='allow-scripts allow-same-origin' allowfullscreen='true' allowtransparency='true' frameborder='0' height='315' src='https://www.mentimeter.com/app/presentation/aljhzk195d52w158quv1e4rxhsafx7r9/embed' style='position: absolute; top: 0; left: 0; width: 100%; height: 100%;' width='420'></iframe></div>
...
-   Evaluasi dari kebijakan secara berkala harus dilakukan, terutama Neraca Komoditas.
    ...
    - contoh [productivity comission](https://www.pc.gov.au/) di Australia (mirip UKP4)
