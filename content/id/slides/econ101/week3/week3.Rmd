...
book1 <- ggplot()+
  ...
  geom_ribbon(aes(x=c(0,1), ymin=50, ymax = 70,
                  fill = "Joy's surplus"), alpha = 0.4, size=10)+
...
ggplot()+
  ...
  geom_text(data = data2,
            ...
            family = "Source Sans Pro", size=8)+
  geom_ribbon(aes(x=c(0,1), ymin=50, ymax = 70,
                  fill = "Joy's surplus"), alpha = 0.4, show.legend = FALSE, color = 'blue')+
  geom_ribbon(aes(x=c(1,2), ymin=50, ymax = 60,
...
```{r grafik6,echo=FALSE, message=FALSE, warning=FALSE, fig.width=10}
...
```{r grafik9,echo=FALSE, message=FALSE, warning=FALSE, fig.width=10}
...
.pull-left[
```{r grafik5,echo=FALSE, message=FALSE, warning=FALSE, fig.width=5}
library(tidyverse)
