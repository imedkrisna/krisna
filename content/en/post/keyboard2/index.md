...
title: "Is the Blackwidow V3 Mini Hyperspeed any good? Trying the yellow switch!"
subtitle: ""
summary: ""
authors: [admin]
tags: [miscellaneous]
...
In my previous post, I wrote about [my first-ever switch to a mechanical keyboard]({{< relref "/post/keyboard" >}}). My last non-mechanical keyboard was the [Logitech MX Keys](https://www.logitech.com/en-au/products/keyboards/mx-keys-wireless-keyboard.920-009418.html), which I bought for work from home. In that post I also described my journey to the [Razer Huntsman](https://www2.razer.com/au-en/gaming-keyboards-keypads/razer-huntsman), a keyboard that's mechanical but technically optical.

## Why mechanical keyboards and Razer?

I switched to mechanical keyboards because they're widely recommended in typist forums. On top of that, mechanical keyboards can be programmed with macros and remapped keys with custom functions. This is super useful for my daily work. I've loaded my keyboard's extra functions with various _text_ snippets for _commands_ and _methods_ in languages I frequently use, such as _(R)markdown syntax_, Python, and Stata.

For adding functions and alternate key assignments, I've found Razer to be among the best. It can remap all keys and add functions to every key (Razer calls this [Hypershift](https://insider.razer.com/index.php?threads/what-exactly-is-hypershift.33117/)). For example, I can store the text `{{</* icon name="exclamation-triangle" pack="fas" */>}}` on the K key. I can bring up that text by pressing fn+K. And every key can do this.

By the way, the _syntax_ above renders on my blog as this -> {{< icon name="exclamation-triangle" pack="fas" >}}

The main drawback of Razer is the price. Fortunately, in Australia and on Amazon, there are frequent big sales, especially around the end of the _financial year_ and _Boxing Day_. Razer also has a student discount program, which is very helpful for a student like me.
...
Mechanical keyboards also come with all sorts of _switch_ types. Since they're expensive, most people will only buy one. But which one? In this post, I want to compare three Razer switches I've tried. They are Razer Purple, Razer Green, and Razer Yellow.
...
This time I'll discuss the [Blackwidow V3 Mini](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwiet_f09NzxAhUdyzgGHa-7DMgQFnoECAIQAA&url=https%3A%2F%2Fwww2.razer.com%2Fau-en%2Fstore%2Frazer-blackwidow-v3-mini-hyperspeed&usg=AOvVaw1esvYYHL2PSA_pgo2JVxJF) with the Yellow switch.
