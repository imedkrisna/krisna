...
Today I saw on Twitter some concern over a Kompas article. The article reported that [Indonesia would continue exporting Personal Protective Equipment (PPE)](https://nasional.kompas.com/read/2020/04/14/19223961/menkeu-sebut-ri-tetap-ekspor-apd-tanpa-kurangi-kebutuhan-dalam-negeri). The context is, of course, COVID-19: amid a pandemic, Indonesia itself needs a lot of PPE. How can we be exporting to other countries?
...
Indonesia enacted its export ban through Ministry of Trade Regulation No. 31/2020. I wrote about it in [another blog post](https://imedkrisna.github.io/coronatrade/). But that post probably still referenced the earlier restriction. The export ban has now been expanded to include thermometers and ethyl alcohol.
...
In the 3M vs US case, [the US ultimately agreed to let 3M continue exporting](https://www.marketwatch.com/story/3m-hits-back-at-trump-says-ceasing-exports-of-n95-masks-will-have-opposite-effect-humanitarian-consequences-2020-04-03). The EU received much criticism for its *export ban* (including [from PIIE](https://www.piie.com/blogs/trade-and-investment-policy-watch/how-g20-can-strengthen-access-vital-medical-supplies-fight) (btw that PIIE article is great -- lots of data)), until it eventually [softened and relaxed its ban](https://www.reedsmith.com/en/perspectives/2020/03/the-fight-against-covid-19-and-eu-and-us-export-controls). There are many reasons. One is humanitarian. Right now, the whole world needs these goods, not just the US or EU. 3M said it wanted to continue helping countries in need, like those in Latin America and elsewhere.

The next problem is *supply chain*. Making proper, standards-compliant, quality PPE requires non-trivial raw materials. I don't know the details, but according to [this article](https://www.npr.org/sections/goatsandsoda/2020/03/16/814929294/covid-19-has-caused-a-shortage-of-face-masks-but-theyre-surprisingly-hard-to-mak), at least for masks, the raw materials are quite specialized. Of course we could substitute with cloth, but how could we let healthcare workers on the front lines use masks and PPE that aren't *medical grade*?
