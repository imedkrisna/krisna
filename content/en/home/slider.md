...
[[item]]
  title = "Welcome!"
  content = "Welcome to my website! My name is Krisna. I use This web to host my profile and [CV](#CV). I ocassionally fill the site with my [blog posts](#posts). I also host some of my [talks](#talks) and [courses](/courses) in this site. Click the [search](/search) button if you get lost. Thanks for coming by!"
  align = "center"

  cta_label = "bahasa indonesia"
  cta_url = "https://krisna.netlify.app/"
  cta_icon_pack = "fas"
  cta_icon = "window-minimize"
